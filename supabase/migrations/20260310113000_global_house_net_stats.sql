-- Expose a net/realizable house metric so dashboard totals align with actual money in system.
-- Keep existing gross house_take metric for historical turnover analysis.

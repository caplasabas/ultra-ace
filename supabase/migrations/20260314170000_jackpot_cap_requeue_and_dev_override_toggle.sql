-- Restore assignment-time max-win capping with overflow requeue for real jackpot triggers.
-- Add DEV override toggle: by default DEV follows same cap rules as real.

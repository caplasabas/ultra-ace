-- Keep house fixed to the configured profile percentage.
-- Let jackpot flex based on the post-win remainder instead of taking a strict fixed cut.
-- Happy pool receives the final remainder.

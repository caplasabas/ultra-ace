...
begin
  ...
  if v_event = 'coins_in' then
    ...
    -- House and jackpot are fixed percentages of BET.
    -- Happy pool gets remainder share and absorbs spin win:
    --   happy_delta = (bet * happy%) - totalWin
    ...
    v_jackpot_contrib := v_bet * v_jackpot_pct / 100.0;
    v_pool_contrib := (v_bet * v_happy_pct / 100.0) - v_spin_win_hint;
